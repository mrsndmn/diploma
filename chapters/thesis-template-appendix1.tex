...
\begin{figure}[t]
	\centering
	\includegraphics[heihth=10cm]{./img/fcm_losses.png}
...
\begin{figure}[t]
	\centering
	\includegraphics[heihth=10cm]{./img/plot_concept_history.png}
	\caption{Результат работы метода \verb|plot_concept_history| для карты, обученной на 80 точках исследуемых данных.}
